...
class WP_Wax_Custom_Post
{
    ...
    public function register_custom_post_type()
    {
        ...
        $args = array(
            ...
            'rewrite' => array( 'slug' => 'directorist', 'with_front' => FALSE ),
        ...
        $dlist_args = array(
            ...
            'exclude_from_search' => false,
            'publicly_queryable' => true,
            'rewrite' => array( 'slug' => 'dlist', 'with_front' => FALSE ),
            'capability_type' => 'post',
        ...
        $direo_args = array(
            ...
            'exclude_from_search' => false,
            'publicly_queryable' => true,
            'rewrite' => array( 'slug' => 'direo', 'with_front' => FALSE ),
            'capability_type' => 'post',
        ...
        $directoria_args = array(
            ...
            'exclude_from_search' => false,
            'publicly_queryable' => true,
            'rewrite' => array( 'slug' => 'directoria', 'with_front' => FALSE ),
            'capability_type' => 'post',
        ...
        $findbiz_args = array(
            ...
            'exclude_from_search' => false,
            'publicly_queryable' => true,
            'rewrite' => array( 'slug' => 'findbiz', 'with_front' => FALSE ),
            'capability_type' => 'post',
        ...
        $dservice_args = array(
            ...
            'exclude_from_search' => false,
            'publicly_queryable' => true,
            'rewrite' => array( 'slug' => 'dservice', 'with_front' => FALSE ),
            'capability_type' => 'post',
        ...
        $drestaurant_args = array(
            ...
            'exclude_from_search' => false,
            'publicly_queryable' => true,
            'rewrite' => array( 'slug' => 'drestaurant', 'with_front' => FALSE ),
            'capability_type' => 'post',
